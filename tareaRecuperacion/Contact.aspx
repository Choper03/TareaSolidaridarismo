<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="tareaRecuperacion.Contact" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div style="padding:15px">
        ...
        <table class="w-70" style="height: 287px; width: 1208px">
            <tr>
                <td colspan="2" style="font-size: xx-large; background-color: #333333; color: #FFFFFF; height: 46px;">Creditos&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="text-end" style="width: 604px; height: 30px">
                    <asp:Label ID="Label2" runat="server" Font-Size="Medium" Text="Seleccione un Cliente:" BorderColor="Blue" BorderStyle="Double"></asp:Label>
                </td>
                <td class="text-start" style="height: 30px; width: 604px">
                    <asp:DropDownList ID="dropDownListClientes" runat="server" AutoPostBack="True" BackColor="#66FFFF">
                    </asp:DropDownList>
            ...
            <tr>
                <td class="text-end" style="width: 604px; height: 30px">
                    <asp:Label ID="Label3" runat="server" Font-Size="Medium" Text="Estado:" BorderColor="Blue" BorderStyle="Double"></asp:Label>
                </td>
                <td class="text-start" style="height: 30px; width: 604px">
                    <asp:TextBox ID="TxtEstado" runat="server" Font-Size="Medium" TextMode="Number" Width="500px" BackColor="#66FFFF" ></asp:TextBox>
                </td>
            </tr>
            <tr>
